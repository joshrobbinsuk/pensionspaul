...
class Fund(models.Model):
    ...
    fixed_costs_year_start = models.DecimalField(
    ...
    platform_type = models.CharField(
        max_length=3, choices=PLATFORM_CHOICES, default="itb"
    )
    GROWTH_TYPE_CHOICES = (("n", "Normal"), ("s", "Special"))
    growth_type = models.CharField(
        max_length=1, choices=GROWTH_TYPE_CHOICES, default="n"
    )
    band_1_lower = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
        default=0,
        verbose_name=("Band 1 start value (£)"),
    )
    band_1_rate = models.DecimalField(
        ...
        null=True,
        blank=True,
        verbose_name=("BAND 1 RATE (%)"),
    )
    end_1_band_2 = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
        verbose_name=("Band 1 end value/Band 2 start (£)"),
    )
    band_2_rate = models.DecimalField(
        ...
        null=True,
        blank=True,
        verbose_name=("BAND 2 RATE (%)"),
    )
    end_2_band_3 = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
        verbose_name=("Band 2 end value/Band 3 start (£)"),
    )
    band_3_rate = models.DecimalField(
        ...
        null=True,
        blank=True,
        verbose_name=("BAND 3 RATE (%)"),
    )
    end_3_band_4 = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
        verbose_name=("Band 3 end value/Band 4 start (£)"),
    )
    band_4_rate = models.DecimalField(
        ...
        null=True,
        blank=True,
        verbose_name=("BAND 4 RATE (%)"),
    )
    end_4_band_5 = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
        verbose_name=("Band 4 end value/Band 5 start (£)"),
    )
    band_5_rate = models.DecimalField(
        ...
        null=True,
        blank=True,
        verbose_name=("BAND 5 RATE (%)"),
    )
    end_5_band_6 = models.DecimalField(
        max_digits=10,
        decimal_places=2,
        null=True,
        blank=True,
        verbose_name=("Band 5 end value/Band 6 start (£)"),
    )
    band_6_rate = models.DecimalField(
        max_digits=10,
        decimal_places=3,
        null=True,
        blank=True,
        verbose_name=("BAND 6 RATE (%)"),
    )
    ...
    def method_drawdown(self):
        new_pot = (
            self.method_fixed_start_costs() * Decimal(100 - self.drawdown_pc) / 100
        )
    ...
    ###### DADDY + MUMMY METHODS -- CALLED IN THE VIEWS
    ...
    def daddy_method(self):
        ...
        self.costs_accrued -= self.setup_costs * (
            self.comparison_years - 1
        )  # only year one setup costs
        return new_pot
